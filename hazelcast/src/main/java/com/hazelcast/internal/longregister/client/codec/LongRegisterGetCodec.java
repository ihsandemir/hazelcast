 ...
 */
@Generated("d600b046bf716393daaa4cf0a3f669b4")
public final class LongRegisterGetCodec {
    ...
    public static LongRegisterGetCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
    ...
    public static LongRegisterGetCodec.ResponseParameters decodeResponse(ClientMessage clientMessage) {
