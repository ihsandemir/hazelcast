...
public final class ClientMessage implements OutboundFrame, Iterator<ClientMessage.Frame> {
    ...
    public int getNumberOfBackupAcks() {
        return Bits.readIntL(startFrame.content, RESPONSE_BACKUP_ACKS_FIELD_OFFSET);
    }
    ...
    public ClientMessage setNumberOfBackupAcks(final int numberOfAcks) {
        Bits.writeIntL(startFrame.content, RESPONSE_BACKUP_ACKS_FIELD_OFFSET, numberOfAcks);
        return this;
    }
