...
public class MapAddPartitionLostListenerMessageTask
    ...
    protected CompletableFuture<EventRegistration> processInternal() {
        ...
        if (parameters.localOnly) {
            eventRegistration = mapServiceContext.addLocalPartitionLostListener(listener, parameters.name);
        } else {
            eventRegistration = mapServiceContext.addPartitionLostListener(listener, parameters.name);
        }
