...
public final class EntryListCodec {
    ...
    public static <K, V> List<Map.Entry<K, V>> decode(ClientMessage iterator,
                                                      Function<ClientMessage, K> decodeKeyFunc,
                                                      Function<ClientMessage, V> decodeValueFunc) {
    ...
    public static <K, V> List<Map.Entry<K, V>> decodeNullable(ClientMessage iterator,
                                                              Function<ClientMessage, K> decodeKeyFunc,
                                                              Function<ClientMessage, V> decodeValueFunc) {
