...
public final class ListMultiFrameCodec {
    ...
    public static <T> List<T> decode(ClientMessage iterator,
                                     Function<ClientMessage, T> decodeFunction) {
    ...
    public static <T> List<T> decodeContainsNullable(ClientMessage iterator,
                                                     Function<ClientMessage, T> decodeFunction) {
        List<T> result = new LinkedList<>();
        //begin frame, list
        iterator.next();
    ...
    public static <T> List<T> decodeNullable(ClientMessage iterator,
                                             Function<ClientMessage, T> decodeFunction) {
