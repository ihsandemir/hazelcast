...
public abstract class AbstractMultiMapAddEntryListenerMessageTask<P> extends AbstractAddListenerMessageTask<P> {
    ...
    protected CompletableFuture<EventRegistration> processInternal() {
        ...
        return service.addListener(name, listener, key, includeValue, isLocalOnly());
    }
