...
public class SetAddListenerMessageTask
    ...
    protected CompletableFuture<EventRegistration> processInternal() {
        ...
        if (parameters.localOnly) {
            eventRegistration = eventService.registerLocalListener(getServiceName(), parameters.name, filter, listener);
        } else {
            eventRegistration = eventService.registerListener(getServiceName(), parameters.name, filter, listener);
        }
